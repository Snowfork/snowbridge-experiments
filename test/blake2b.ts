...
describe("Blake2b", function () {
  ...
  describe("hash", function () {
    it.skip("should work", async function () {
      ...
      const expected =
        "0x2319e3789c47e2daa5fe807f61bec2a1a6537fa03f19ff32e87eecbfd64b7e0e8ccff439ac333b040f19b0c4ddd11a61e24ac1fe0f10a039806c5dcc0da3d115"

      expect(await blake2b.hash(input)).to.equal(expected)
    })
  })
