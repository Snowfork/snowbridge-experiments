...
contract Blake2bConsenSys {
    ...
    function compress(Blake2bConsenSys_ctx memory ctx, bool last) internal view {
    ...
    function init(
        Blake2bConsenSys_ctx memory ctx,
        uint64 outlen,
        bytes memory key,
    ...
    function update(Blake2bConsenSys_ctx memory ctx, bytes memory input) internal view {
    ...
    function finalize(Blake2bConsenSys_ctx memory ctx, uint64[8] memory out) internal view {
