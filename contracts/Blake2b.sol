...
contract Blake2b {
    ...
    function hash(bytes calldata m) public view returns (bytes32) {
        ...
        h[0] = h[0] ^ bytes32(hex"01010000") ^ (bytes32(nn) << (8*24));

        // console.logBytes8(uintToBytes8(nn));
        // console.logBytes8(bytes8(hex"01010000") ^ uintToBytes8(nn));
        // console.logBytes32(bytes32(bytes8(hex"01010000") ^ uintToBytes8(nn)));
        // console.logBytes32(bytes32(hex"01010000") ^ (bytes32(nn) << (8*24)));
